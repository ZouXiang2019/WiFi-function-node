...
// void set_data10(char *data_set)
// {
//     strcpy(data10, data_set);
// }


void socket_transmitter_sta_loop10() {
    int socket_fd = -1;
    while (1) {
        close(socket_fd);
        ...
        while (1) {
            ...
            if (sendto(socket_fd, &data10, strlen(data10), 0, (const struct sockaddr *) &caddr, sizeof(caddr)) !=
                strlen(data10)) {
                vTaskDelay(1);
                continue;
            }
